    ...
    PackageUtilities.runParallelBatches(
      ...
      pkg => {
        ...
        const run = cb => {
          ...
          NpmUtilities.publishTaggedInDir(tag, publishLocation, this.npmConfig, err => {
